...
export const LoginPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            const role = await login({ identifier: phone, password });
            ...
            setError(err?.response?.data?.message ?? 'Telefon numarası veya şifre hatalı.');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm text-gray-500 mt-1">Telefon numaranız ve şifrenizle devam edin</p>
                </div>
